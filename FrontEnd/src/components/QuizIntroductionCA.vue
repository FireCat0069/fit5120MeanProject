    ...
    <div class="quiz-container">
      <div class="quiz-page">
            ...
            <nav class="nav-links">
              ...
              <router-link to="/dashboard-i3" class="nav-item">DashBoard</router-link>
            </nav>
            </div>
            <!-- Right content area -->
            ...
            <div class="quiz-section">
                    ...
                    <div class="quiz-section-1">
                        <!-- Quiz title -->
                        <h1 class="quiz-title">Cybersecurity Awareness</h1>
                    ...
                    <div class="quiz-section-2">
                        ...
                        <!-- Start Quiz button -->
                        <router-link 
                          :to="{ path: '/Quiz-Content', query: { section: 'Cybersecurity Awareness' } }"
